...
class GoogleAuthenticator {
	 ...
	 * @param array       $params
	 * @param bool        $returnOtpUrl
	 * @return string
	 */
	public static function getQRCodeGoogleUrl(string $name, string $secret, ?string $title = null, array $params = [], bool $returnOtpUrl = false): string {
		...
		if ($returnOtpUrl) return $urlencoded;
...
//        }
	 ...
	 *
	 * @param int $length
	 * @return string|GoogleAuthenticator
	 */
	public static function setCodeLength(int $length): string|GoogleAuthenticator {
